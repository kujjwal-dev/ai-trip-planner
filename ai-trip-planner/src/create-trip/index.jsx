      ...
      <div>
        ...
        <div className='grid grid-cols-3 gap-5 mt-5'>
          {SelectBudgetOptions.map((item, index) => (
            ...
            <div key={index} onClick={() => handleInputChnage('budget', item.title)}
              className={`p-4 rounded-lg cursor-pointer hover:shadow-lg  ${formData?.budget == item.title && 'shadow-lg border-black'}`}>
      ...
      <div>
        ...
        <div className='grid grid-cols-3 gap-5 mt-5'>
          {SelectTravelList.map((item, index) => (
            ...
            <div key={index} onClick={() => handleInputChnage('traveler', item.title)}
              className={`p-4 rounded-lg cursor-pointer hover:shadow-lg ${formData?.traveler == item.people && 'shadow-lg border-black'}`}>
              <h2 className='text-4xl'>{item.icon}</h2>
              <h2 className='font-bold text-lg'>{item.title}</h2>
              <h2 className='text-sm text-gray-500'>{item.desc}</h2>
            </div>
